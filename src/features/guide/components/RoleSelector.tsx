...
const roleColorMap: Record<GuideRole, string> = {
  seer: 'border-oe-aurora-violet/40 bg-oe-aurora-violet/10 text-oe-aurora-violet-ink',
...
const roleColorInactive: Record<GuideRole, string> = {
  seer: 'hover:border-oe-aurora-violet/20 hover:text-oe-aurora-violet-ink',
          ...
          <button
            ...
            className={cn(
              ...
              isActive
                ...
                : cn(
                    'border-oe-pure-light/10 text-oe-pure-light/55',
